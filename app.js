// ============================================================
//  APEX PERFORMANCE â€” app.js (ScrollCanvas Engine v3)
...
loaderEl.innerHTML = `
  <div class="loader-inner">
    <img src="images/logo.png" alt="APEX PERFORMANCE" style="width:112px;height:112px;object-fit:contain;border-radius:10px;margin-bottom:8px">
    <div class="loader-logo">APEX PERFORMANCE</div>
...
loaderCSS.textContent = `
  ...
  .loader-bar-wrap {
    width:260px; height:2px; background:rgba(249,115,22,.2);
  ...
  .loader-pct { font-size:.75rem; color:rgba(249,115,22,.6); letter-spacing:.15em; }
`;
